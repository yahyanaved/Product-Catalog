    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="img/productdemo" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <p class="mb-4"><?php echo $row['p_desc'];?></p>
                <h3 class="font-weight-semi-bold mb-4">Store Info</h3>
                <p class ="mb-4">Address : <?php echo $row['address'];?></p>
                <p class = "mb-4">Email : <?php echo $row['email'];?></p>
                <p class = "mb-4">Description : <?php echo $row['store_desc'];?></p>
            </div>
            <?php } ?>
        </div>
        <div class="row px-xl-5">
