    ...
    <div class="form_wrapper">
        <div class="form_container">
            ...
            <div class="row clearfix">
                <div class="">
                    <form action="signuprw.php" method="POST">
                        ...
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
                            <input type="text" name="s_name" placeholder="Store Name" required />
                        </div>
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
                            <input type="text" name="store_desc" placeholder="Store Description" required />
                        </div>
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
                            <input type="text" name="address" placeholder="Store Address" required />
                        </div>
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
                            <input type="text" name="email" placeholder="Store Email" required />
                        </div>
